const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "0402", // Change this to any 4-digit code (the passcode for access)
  ...
  trendingSearches: [
    "Why is my wifey so cute?", // Example trending search query
    "Why does Ranju love him more?", // Another example query
    `Ranjana's birthdate (coz her husband forgets)`, // A personalized trending search
  ],
  proTip: 'Pro tip: try searching "How long have we been together?" ;)', // Helpful tip for users

  // ⏳ Timer Page
  anniversaryDate: "2023-02-04", // 📅 Set your anniversary date here (used for the timer)
